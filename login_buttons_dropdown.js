(function () {
  ...
  //
  // loginButtonsLoggedInFull template and related
  //

  Template._loginButtonsLoggedInFull.events({
  ...
  Template._loginButtonsLoggedInFull.displayName = function () {
    return Accounts._loginButtons.displayName();
  };

  Template._loginButtonsLoggedInFull.inChangePasswordFlow = function () {
    return loginButtonsSession.get('inChangePasswordFlow');
  };

  Template._loginButtonsLoggedInFull.inMessageOnlyFlow = function () {
    return loginButtonsSession.get('inMessageOnlyFlow');
  };

  Template._loginButtonsLoggedInFullActions.allowChangingPassword = function () {
  ...
  //
  // loginButtonsLoggedOutFull template and related
  //

  Template._loginButtonsLoggedOutFull.events({
  ...
  Template._loginButtonsLoggedOutFull.additionalClasses = function () {
  ...
  Template._loginButtonsLoggedOutFull.hasPasswordService = function () {
